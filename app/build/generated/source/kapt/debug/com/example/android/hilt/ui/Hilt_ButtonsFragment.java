...
public abstract class Hilt_ButtonsFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_ButtonsFragment() {
    super();
  }

  Hilt_ButtonsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((ButtonsFragment_GeneratedInjector) generatedComponent()).injectButtonsFragment(UnsafeCasts.<ButtonsFragment>unsafeCast(this));
  }
